package com.jaygoaler.pitools.utils.dateutil;
...
public final class DateUtils {
    ...
    public static Date converToDate(String dateTime) throws ParseException {
        return converToDate(dateTime, DateFormat.DATE_FORMAT);
    }
     ...
     * @throws ParseException
     */
    public static String getNowQuarterStr(String dateTime) throws ParseException {
        return getNowQuarterStr(converToDate(dateTime));
    }
     ...
     * @throws ParseException
     */
    public static String getNowQuarterStr(long dateTime) throws ParseException {
        return getNowQuarterStr(converToDate(formatDate(dateTime, DateFormat.DATE_FORMAT)));
    }
     ...
     * @throws ParseException
     */
    public static String getNowQuarterStr(Date nowDate) throws ParseException {
     ...
     * @throws Exception
     */
    public static String specialYear(String dateTime, int num, String dateFormat) throws Exception {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(converToDate(dateTime, dateFormat));
     ...
     * @throws Exception
     */
    public static String specialMonth(String dateTime, int num, String dateFormat) throws Exception {
        Calendar calendar = Calendar.getInstance();
        calendar.setTime(converToDate(dateTime));
